 ...
 *   https://datatables.net/download/#bs5/jq-3.6.0/dt-1.13.2/b-2.3.4/b-html5-2.3.4/b-print-2.3.4/date-1.3.0/fc-4.2.1/fh-3.3.1/kt-2.8.1/r-2.4.0/sc-2.1.0/sl-1.6.0
 *
 * Included libraries:
 *   jQuery 3 3.6.0, DataTables 1.13.2, Buttons 2.3.4, HTML5 export 2.3.4, Print view 2.3.4, DateTime 1.3.0, FixedColumns 4.2.1, FixedHeader 3.3.1, KeyTable 2.8.1, Responsive 2.4.0, Scroller 2.1.0, Select 1.6.0
 */
