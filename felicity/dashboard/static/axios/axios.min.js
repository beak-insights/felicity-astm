!(function (e, t) {
  ...
  var Y,
    ...
    ae = {
      isBrowser: !0,
      classes: { URLSearchParams: ne, FormData: re, Blob: Blob },
  ...
  var ce = {
    ...
    transformRequest: [
      function (e, t) {
        ...
        if ((i && I.isHTMLForm(e) && (e = new FormData(e)), I.isFormData(e)))
          return o && o ? JSON.stringify(se(e)) : e;
        if (
          I.isArrayBuffer(e) ||
          I.isBuffer(e) ||
          I.isStream(e) ||
    ...
    transformResponse: [
      function (e) {
        var t = this.transitional || ce.transitional,
      ...
      r(
        ...
        [
          ...
          },
          {
            key: "accessor",
            value: function (e) {
              var t = (this[de] = this[de] = { accessors: {} }).accessors,
                n = this.prototype;
              function r(e) {
                var r = he(e);
                t[r] ||
  ...
  var Se = ae.isStandardBrowserEnv
    ? (function () {
        var e,
  ...
  var Te = function (e) {
    for (
      ...
      o < r && ((t = e[o]), !(n = I.isString(t) ? Ae[t.toLowerCase()] : t));
      o++
    );
    if (!n) {
      if (!1 === n)
  ...
  function Ne(e) {
    return (
      ...
      Te(e.adapter || fe.adapter)(e).then(
        function (t) {
          return (
            je(e),
      ...
      return (
        r(e, [
          ...
          },
          {
            ...
            value: function (e) {
              return Z(
                Oe((e = Ce(this.defaults, e)).baseURL, e.url),
                e.params,
                e.paramsSerializer
              );
            },
